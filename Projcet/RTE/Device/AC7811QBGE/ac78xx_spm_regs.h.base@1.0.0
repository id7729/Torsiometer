...
#define SPM_WAKEUP_IRQ_STATUS_NMI_Msk            (0x00040000UL)
#define CKGEN_RESET_STATUS_XOSC_LOSS_STATUS_Msk  (0x00000200UL)
#define CKGEN_RESET_STATUS_CLR_RESET_STATUS_Msk  (0x00010000UL)
...
#define REG_RESET_STATUS        (0x40000010)
